                      ...
                      <div className="p-4 w-full mx-auto max-w-md h-full md:h-auto flex items-center">
                        <div className="relative rounded-lg shadow bg-gray-700">
                          ...
                          <div className="flex justify-between items-center p-6 space-x-2 rounded-b border-t border-gray-600">
                            ...
                            <button onClick={() => handleModalButton()} data-modal-toggle="small-modal" type="button" className="text-white  focus:ring-4 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center bg-blue-600 hover:bg-blue-700 focus:ring-blue-800">
