        ...
        <div className="quiz md:w-1/2 mx-auto text-white py-2">
          <div className="questions flex items-center justify-between py-4">
            <button type="button" disabled={true} className="inline-flex relative items-center p-3 text-sm font-medium text-center text-white rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none  bg-blue-800">
              ...
              <div className="inline-flex absolute -top-2 -right-2 justify-center items-center w-6 h-6 text-xs font-bold text-white bg-red-500 rounded-full border-2 border-white border-gray-900">{quesLen}</div>
            </button>
            <div>
                    ...
                    <div id="small-modal" tabIndex="-1" className={`${isOptionDisabled ? "" : "hidden"} bg-opacity-30 bg-black flex justify-center items-center overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 w-full h-full md:inset-0 h-modal md:h-full`}>
                      <div className="p-4 w-full max-w-md h-full md:h-auto flex items-center">
                        <div className="relative rounded-lg shadow bg-gray-700">
                          <div className="flex flex-col justify-between items-start p-5 rounded-t border-b border-gray-600">
                            ...
                            <button type="button" className="text-gray-400 bg-transparent hover:bg-gray-200 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center hover:bg-gray-600 hover:text-white" data-modal-toggle="small-modal"></button>
                          </div>
                          ...
                          <div className="flex justify-between items-center p-6 space-x-2 rounded-b border-t border-gray-600">
                            ...
                            <button onClick={() => handleModalButton()} data-modal-toggle="small-modal" type="button" className="text-white focus:ring-4 focus:outline-none  font-medium rounded-lg text-sm px-5 py-2.5 text-center bg-blue-600 bg-blue-700 focus:ring-blue-800">
