    ...
    <section className="bgimg min-h-screen w-full">
      <div className="main container mx-auto py-8 px-8 min-h-screen">
        ...
        <div className="md:w-1/3">
          <div class="flex p-4 opacity-75 text-[10px] tracking-wide text-gray-700 bg-gray-100 rounded-lg dark:bg-gray-700 dark:text-gray-300" role="alert">
            <svg aria-hidden="true" class="flex-shrink-0 inline w-5 h-5 mr-3" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
              <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"></path>
            </svg>
            <span class="sr-only">Info</span>
            <div>
              <span class="font-medium">Careful!</span> One account is for a single game session. If you want to play again, you have to create a new account with new username.
            </div>
          </div>
        </div>
      </div>
