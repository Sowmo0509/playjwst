          ...
          <div className="toptitle text-center py-8 flex flex-col items-center gap-4">
            ...
            <div className="waitingForUser animate-pulse">
              <div id="toast-simple" class="flex items-center p-4 space-x-4 w-full max-w-xs text-gray-500 bg-white rounded-lg divide-x divide-gray-200 shadow dark:text-gray-400 dark:divide-gray-700 space-x dark:bg-gray-800" role="alert">
                {isWaiting ? (
                  ...
                  <>
                    <div className="spinnerLoadingNow">
                      <div role="status">
                        <svg aria-hidden="true" class="w-6 h-8 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="pl-4 text-sm font-normal">{isWaiting ? "awaiting user input..." : "starting game..."}</div>
              </div>
            </div>
          </div>
